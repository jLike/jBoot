...
package io.github.jbooter.web.filter;
...
public class CachingHttpHeadersFilter implements Filter {
    ...
    public CachingHttpHeadersFilter(JBooterProperties jBooterProperties) {
        this.jBooterProperties = jBooterProperties;
    }

    @Override
    public void init(FilterConfig filterConfig) throws ServletException {
        cacheTimeToLive = TimeUnit.DAYS.toMillis(jBooterProperties.getHttp().getCache().getTimeToLiveInDays());
    }
